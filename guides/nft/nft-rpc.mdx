...
| "series_number" (deprecated) | Beginning in Chia version 1.5, please use the `edition_number` parameter instead of this one.                                                                       |
| "series_total" (deprecated)  | Beginning in Chia version 1.5, please use the `edition_count` RPC instead of this one.                                                                              |
...
| "edition_count"              | If this NFT has multiple **editions**, then this parameter indicates the total number of editions of this NFT. This parameter should be used with `edition_number`. |
