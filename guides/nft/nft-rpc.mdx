...
| "series_number" (deprecated) | Beginning in Chia version 1.4.1, please use `edition_number`  |
| "series_total"  (deprecated) | Beginning in Chia version 1.4.1, please use `edition_count`   |
...
| "edition_count"      | If this NFT has multiple editions, then this parameter indicates the total number of editions of this NFT. This parameter should be used if and only if the `edition_number` parameter was also used |
