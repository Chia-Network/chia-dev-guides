...
The code to be released in version 1.4 (including NFTs and DIDs) is in the [release/1.4.0](https://github.com/Chia-Network/chia-blockchain/tree/release/1.4.0) branch of the `chia-blockchain` repository. You'll need to download this branch.
