...
If you are using v1.4.0, you can continue to use the `-sn` and `-st` flags, but be aware that these refer to the **edition number** and **edition total number** respectively.
...
| `-sn` [(WARNING)](#editions-and-series) | The **edition** number. Specify if this NFT has multiple editions (multiple identical copies of an NFT). [default: 1]                                         |
| `-st` [(WARNING)](#editions-and-series) | The **edition** total number. Specify if this NFT has multiple editions. [default: 1]                                |
