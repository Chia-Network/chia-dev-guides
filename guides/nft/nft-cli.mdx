...
| -sn (deprecated)     | Beginning in Chia version 1.5, please use `en` (`edition-number`) instead.                           |
| -st (deprecated)     | Beginning in Chia version 1.5, please use `ec` (`edition-count`) instead.                            |
| -en                  | The edition number. Specify if this NFT has multiple editions (multiple identical copies of an NFT). |
| -ec                  | The edition total number. Specify if this NFT has multiple editions.                                 |
