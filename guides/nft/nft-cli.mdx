...
| `-sn` (deprecated)   | Beginning in Chia version 1.4.1, please use `en` (`edition-number`)     |
| `-st` (deprecated)   | Beginning in Chia version 1.4.1, please use `ec` (`edition-count`)      |
| `-en`                | The edition number. Specify if this NFT has multiple editions (multiple identical copies of an NFT). [default: 1] |
| `-ec`                | The edition total number. Specify if this NFT has multiple editions. [default: 1] |
